...
39        e to clipboard if requires                                  *;         ***********************************************************************;         data _null_;                                                                       length pgm
39                                                                    file "c:/temp/r_pgm.txt" lrecl=32766 recfm=v;                                                      pgm=resolve('        library(sqldf);         sex<-fn$sqldf(          "           selec
...
39      !                                                                                                                                                       ***********************************************************************;         * handle input
39        ts and source the code file                  *;         ***********************************************************************;         data _null_;                                                                        file "c:/temp/rcode.r";
...
47        e to clipboard if requires                                  *;         ***********************************************************************;         data _null_;                                                                       length pgm
47                                                                    file "c:/temp/r_pgm.txt" lrecl=32766 recfm=v;                                                      pgm=resolve('        library(sqldf);         sex<-fn$sqldf(          "           selec
...
47      !                                                                                                                                                       ***********************************************************************;         * handle input
47        ts and source the code file                  *;         ***********************************************************************;         data _null_;                                                                        file "c:/temp/rcode.r";
